...
- :crystal_ball: Divination: new Thoth Tarot innovations such as the Solar Pyramid [Spread](https://github.com/Sunhotep/Sunhotep/blob/main/Solar_Pyramid.png), the Lunar Pyramid [Spread](https://github.com/Sunhotep/Sunhotep/blob/main/Lunar_Pyramid.png) inspired by Djedi's Heka magic from [Westcar Papyrus](https://mjn.host.cs.st-andrews.ac.uk/egyptian/texts/corpus/pdf/Westcar.pdf).

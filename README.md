...
- :globe_with_meridians: **Mathematical Modeling**: As team captain and machine learning leader, I led my team to win the 2022 [MCM/ICM](https://www.comap.com/contests/mcm-icm) M Award (First Prize 7%) by our paper regarding impact of asteroid mining on global equity using multiple machine learning methods, and to be included as a member of Consortium for Mathematics and its Applications (COMAP, US).
...
### Energy
- :person_fencing: **Epee Fencing Enthusiast**.
- :runner: **10-K runner**. 

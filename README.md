...
- :crystal_ball: Devination: new Thoth Tarot innovations [Solar Pyramid Spread](https://github.com/Sunhotep/Sunhotep/blob/main/Solar_Pyramid.png), [Lunar Pyramid Spread](https://github.com/Sunhotep/Sunhotep/blob/main/Lunar_Pyramid.png) inspired by Djedi's magic from [Westcar Papyrus](https://mjn.host.cs.st-andrews.ac.uk/egyptian/texts/corpus/pdf/Westcar.pdf).
